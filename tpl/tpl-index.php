...
<body>
          ...
          <ul>
            ...
            <li>
              <form action="" method="post">
                <input type="text" name="" id="" class="newFolder">
                <input type="submit" value="+" class="newFolderSubmit">
              </form>
            </li>
          </ul>
        </div>
  ...
  <script src="<?= BASE_URL . "assets/index/script.js"; ?>"></script>
  <script>
    $(".newFolderSubmit").on("click", function() {
      $.ajax({
        url: "process/ajaxRequest.php",
        method: "post",
        data: {
          action: "addFolder",
          data: $(".newFolder").val()
